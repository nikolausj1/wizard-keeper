...
CONNECTIVES = {
 1: {"intro": ["Let's check in on the table!", "Time for the round update!", "Here's how things stand!"],
     "trans": ["Meanwhile...", "And elsewhere...", "There's more, folks...", "Also worth noting...", "In other news..."],
     "outro": ["Back to the cards!", "Good luck out there, everyone!", "Play on, everyone!"]},
 2: {"intro": ["Round update, and ohh, do we have notes!", "Gather 'round — the table has issues!", "The table has developments!"],
     "trans": ["It gets better...", "Meanwhile, in less flattering news...", "And ANOTHER thing...", "Speaking of questionable choices...", "Which brings us to..."],
     "outro": ["Deal 'em up — and try to do better!", "Back to the table. Some of you have work to do!", "Shuffle up \u2014 and do better!"]},
 3: {"intro": ["ROUND UPDATE! Somebody's getting called OUT!", "STOP the presses — you need to hear this!", "BREAKING news from the felt!"],
     "trans": ["Oh, we're NOT done...", "But WAIT, there's carnage...", "And meanwhile, folks...", "And it gets JUICIER...", "Hold on, there's MORE..."],
     "outro": ["That's the update! Pray for the bottom of this table!", "Back to the cards — SHOW me something!", "That's the damage \u2014 back to WAR!"]},
 4: {"intro": ["Round update — and my GOD, where do I start?!", "Listen up! The table demands accountability!", "Gather round for the damage report!"],
     ...
     "outro": ["Update over. Some of you should reflect on your damn choices!", "Back to it — and for the love of GOD, bid better!", "Back at it \u2014 and for God's sake, focus!"]},
 5: {"intro": ["ROUND UPDATE! Buckle the hell up!", "Holy shit, folks, what a round — let's break it down!", "Strap in for the damn update!"],
     "trans": ["Oh, we are NOT done...", "And it gets messier...", "Meanwhile, in dumpster-fire news...", "And in worse news...", "Hold my drink, there's more..."],
...
TAILS = {
 ...
 2: {  # Spicy — the announcer has opinions
  ...
  "hotStreak": ["Another hit! Leave some for everybody else!", "Red hot! The table is in TROUBLE!", "Somebody check for magnets in those cards!", "Untouchable right now \u2014 annoyingly so!"],
